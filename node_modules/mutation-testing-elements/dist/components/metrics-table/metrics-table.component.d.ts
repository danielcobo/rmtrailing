...
export declare type TableWidth = 'normal' | 'large';
export declare type ColumnCategory = 'percentage' | 'number';
export declare type Numbers<TMetrics> = {
...
export declare class MutationTestReportTestMetricsTable<TFile, TMetric> extends LitElement {
