...
class CustomJestConfigLoader {
    ...
    readConfigFromJestConfigFile() {
        ...
        if (configFilePath) {
            const config = util_1.requireResolve(configFilePath);
...
CustomJestConfigLoader.inject = plugin_1.tokens(plugin_1.commonTokens.logger, plugin_1.commonTokens.options);
