...
class ReactScriptsJestConfigLoader {
    ...
    createJestConfig() {
        const createReactJestConfig = util_1.requireResolve('react-scripts/scripts/utils/createJestConfig');
...
ReactScriptsJestConfigLoader.inject = plugin_1.tokens(pluginTokens.resolve);
