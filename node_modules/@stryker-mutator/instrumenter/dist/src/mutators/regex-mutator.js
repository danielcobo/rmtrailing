...
const weapon_regex_1 = tslib_1.__importDefault(require("weapon-regex"));
/**
...
function mutatePattern(pattern) {
    if (pattern.length) {
        try {
            return weapon_regex_1.default.mutate(pattern, weaponRegexOptions).map((mutant) => mutant.pattern);
        }
        catch (err) {
