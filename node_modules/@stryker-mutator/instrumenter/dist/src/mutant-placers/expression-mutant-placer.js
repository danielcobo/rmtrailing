...
exports.expressionMutantPlacer = {
    ...
    place(path, appliedMutants) {
        ...
        expression = syntax_helpers_1.mutationCoverageSequenceExpression(appliedMutants.keys(), expression);
        // Now apply the mutants
        for (const [mutant, appliedMutant] of appliedMutants) {
            expression = core_1.types.conditionalExpression(syntax_helpers_1.mutantTestExpression(mutant.id), appliedMutant, expression);
        }
