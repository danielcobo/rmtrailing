...
const unexpected_exit_handler_1 = require("../unexpected-exit-handler");
...
function buildMainInjector(injector) {
    ...
    return pluginResolverProvider
        .provideValue(_1.coreTokens.timer, new timer_1.Timer()) // greedy initialize, so the time starts immediately
        ...
        .provideClass(_1.coreTokens.reporter, broadcast_reporter_1.BroadcastReporter)
        .provideClass(_1.coreTokens.temporaryDirectory, temporary_directory_1.TemporaryDirectory)
        .provideValue(_1.coreTokens.execa, execa_1.default)
        .provideValue(_1.coreTokens.process, process)
        .provideClass(_1.coreTokens.unexpectedExitRegistry, unexpected_exit_handler_1.UnexpectedExitHandler);
}
...
function createPluginResolverProvider(parent) {
    return parent
        ...
        .provideClass(_1.coreTokens.configReader, config_reader_1.ConfigReader)
        ...
        .provideFactory(plugin_1.commonTokens.options, config_1.markOptions);
}
