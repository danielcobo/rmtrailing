...
exports.EventRecorderReporter = void 0;
...
class EventRecorderReporter {
    ...
    writeToFile(methodName, data) {
        const filename = path_1.default.join(this.options.eventReporter.baseDir, `${this.format(this.index++)}-${methodName}.json`);
...
exports.EventRecorderReporter = EventRecorderReporter;
