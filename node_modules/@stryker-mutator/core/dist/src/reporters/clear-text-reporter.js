...
exports.ClearTextReporter = void 0;
...
const { MutantStatus } = core_1.schema;
class ClearTextReporter {
    constructor(log, options) {
        ...
        this.writeLine = (output) => {
            this.out.write(`${output !== null && output !== void 0 ? output : ''}${os_1.default.EOL}`);
        };
    ...
    onMutationTestReportReady(_report, metrics) {
        ...
        this.writeLine(new clear_text_score_table_1.ClearTextScoreTable(metrics.systemUnderTestMetrics, this.options.thresholds).draw());
    }
        ...
        if (metrics.testMetrics) {
            const reportTests = (currentResult, depth = 0) => {
                ...
                (_a = currentResult.file) === null || _a === void 0 ? void 0 : _a.tests.forEach((test) => {
                    var _a, _b;
                    switch (test.status) {
                        case mutation_testing_metrics_1.TestStatus.Killing:
                            ...
                            break;
                        case mutation_testing_metrics_1.TestStatus.Covering:
                            ...
                            break;
                        case mutation_testing_metrics_1.TestStatus.NotCovering:
    ...
    logExecutedTests(tests, logImplementation) {
        ...
        if (testCount > 0) {
            ...
            if (diff > 0) {
                logImplementation(`  and ${diff} more test${string_utils_1.plural(diff)}!`);
            }
            logImplementation('');
        }
    }
}
exports.ClearTextReporter = ClearTextReporter;
