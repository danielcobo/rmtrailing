...
exports.CommandTestRunner = void 0;
...
class CommandTestRunner {
    ...
    run({ activeMutantId }) {
        return new Promise((res, rej) => {
            const timerInstance = new timer_1.Timer();
            const output = [];
            const env = activeMutantId === undefined ? process.env : { ...process.env, [core_1.INSTRUMENTER_CONSTANTS.ACTIVE_MUTANT_ENV_VARIABLE]: activeMutantId };
                ...
                if (exitCode === 0) {
                    ...
                    return {
                        ...
                        tests: [
                            {
                                id: 'all',
                                failureMessage: output.map((buf) => buf.toString()).join(os_1.default.EOL),
                                name: 'All tests',
...
exports.CommandTestRunner = CommandTestRunner;
/**
 * "command"
 */
