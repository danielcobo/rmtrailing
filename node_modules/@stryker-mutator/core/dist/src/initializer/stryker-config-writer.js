...
exports.StrykerConfigWriter = void 0;
...
class StrykerConfigWriter {
    ...
    write(selectedTestRunner, selectedReporters, selectedPackageManager, additionalPiecesOfConfig, exportAsJson) {
        const configObject = {
            ...
            coverageAnalysis: command_test_runner_1.CommandTestRunner.is(selectedTestRunner.name) ? 'off' : 'perTest',
        };
...
exports.StrykerConfigWriter = StrykerConfigWriter;
