...
exports.ConfigReader = exports.CONFIG_SYNTAX_HELP = void 0;
...
class ConfigReader {
    ...
    readConfig() {
        ...
        if (typeof configModule === 'function') {
            this.log.warn('Usage of `module.exports = function(config) {}` is deprecated. Please use `module.export = {}` or a "stryker.conf.json" file. For more details, see https://stryker-mutator.io/blog/2020-03-11/stryker-version-3#new-config-format');
        ...
        util_1.deepMerge(options, this.cliOptions);
    ...
    loadConfigModule() {
        ...
        if (!this.cliOptions.configFile) {
            try {
                const configFile = require.resolve(path_1.default.resolve(`./${DEFAULT_CONFIG_FILE}`));
                this.log.info(`Using ${path_1.default.basename(configFile)}`);
        ...
        if (typeof this.cliOptions.configFile === 'string') {
            ...
            try {
                ...
                throw new errors_1.ConfigError('Invalid config file', error);
            }
