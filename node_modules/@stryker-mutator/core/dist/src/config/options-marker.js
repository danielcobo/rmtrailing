...
markOptions.inject = typed_inject_1.tokens(plugin_1.commonTokens.options, di_1.coreTokens.validationSchema, plugin_1.commonTokens.logger);
/**
...
function markUnserializableOptions(options, log) {
    if (object_utils_1.isWarningEnabled('unserializableOptions', options.warnings)) {
        const unserializables = util_1.findUnserializables(options);
        if (unserializables) {
