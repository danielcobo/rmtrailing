...
class MutantInstrumenterExecutor {
    ...
    async execute() {
        ...
        const checkerPoolProvider = concurrencyTokenProviderProvider
            ...
            .provideFactory(di_1.coreTokens.checkerFactory, checker_1.createCheckerFactory)
        ...
        const dryRunProvider = checkerPoolProvider
            .provideValue(di_1.coreTokens.files, files)
            .provideClass(di_1.coreTokens.sandbox, sandbox_1.Sandbox)
            .provideValue(di_1.coreTokens.mutants, instrumentResult.mutants);
        const sandbox = dryRunProvider.resolve(di_1.coreTokens.sandbox);
        await sandbox.init();
