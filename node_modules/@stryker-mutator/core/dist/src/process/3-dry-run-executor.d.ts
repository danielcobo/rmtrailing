...
export declare class DryRunExecutor {
    ...
    readonly sandbox: I<Sandbox>;
    static readonly inject: ["$injector", "logger", "options", "timer", "concurrencyTokenProvider", "sandbox"];
    constructor(injector: Injector<DryRunContext>, log: Logger, options: StrykerOptions, timer: I<Timer>, concurrencyTokenProvider: I<ConcurrencyTokenProvider>, sandbox: I<Sandbox>);
