...
class CheckerChildProcessProxy {
    constructor(options, loggingContext) {
        this.childProcess = child_process_proxy_1.ChildProcessProxy.create(require.resolve('./checker-worker'), loggingContext, options, {}, process.cwd(), checker_worker_1.CheckerWorker, []);
    }
    async dispose() {
        var _a;
